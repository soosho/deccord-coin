...
//! Interface for the src/evo part of a deccord node (deccordd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a deccord node (deccordd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a deccord node (deccordd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a deccord node (deccordd process).
...
//! Top-level interface for a deccord node (deccordd process).
class Node
{
public:
    virtual ~Node() {}
