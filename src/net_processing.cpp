 ...
 *  We have 4 times smaller block times in Deccord, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Deccord Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // DCD this code also handles non-TXs (Deccord specific messages)
