...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire lodeccord.
    var _ = context && context._ || require('lodeccord') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of lodeccord methods to
     * make working with arrays, collections, and objects easier. The lodeccord
     * methods are:
     * [`each/forEach`](https://lodeccord.com/docs#forEach), [`forOwn`](https://lodeccord.com/docs#forOwn),
     * [`has`](https://lodeccord.com/docs#has), [`indexOf`](https://lodeccord.com/docs#indexOf),
     * [`map`](https://lodeccord.com/docs#map), and [`reduce`](https://lodeccord.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped lodeccord methods to
     * make working with Suites easier. The wrapped lodeccord methods are:
     * [`each/forEach`](https://lodeccord.com/docs#forEach), [`indexOf`](https://lodeccord.com/docs#indexOf),
     * [`map`](https://lodeccord.com/docs#map), and [`reduce`](https://lodeccord.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add lodeccord methods to Benchmark.
    ...
    // Add lodeccord methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['lodeccord', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
