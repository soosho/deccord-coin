...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 DCD irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on deccordcentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* Deccord features */
    { "deccord",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "deccord",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "deccord",               "gobject",                &gobject,                {} },
    { "deccord",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
