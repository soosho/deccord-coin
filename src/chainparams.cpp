...
// Copyright (c) 2025 The Deccord Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1740823402, nBits=1e0ffff0, nNonce=736405, vtx=1)
...
{
    const char* pszTimestamp = "Deccord Because who doesnt want more digital coins";
    const CScript genesisOutputScript = CScript() << ParseHex("04539c94f6cdf1e4a4d6dd487404e37b05390d52af2ba2543506b2997630c3f53a5b67cbd68cef660d71f62405c708a6d0ee643d5a9aef709ed52849e027d09aa7") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 1 + 30; // V19 activation height + miner confirmation window
        ...
        consensus.defaultAssumeValid = uint256S("0x00000ff69b23f0528de73cfdcb50a8b8f59a756253866b82019c4a17d8268544"); 
        ...
        genesis = CreateGenesisBlock(1740823402, 736405, 0x1e0ffff0, 1, 5 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000ff69b23f0528de73cfdcb50a8b8f59a756253866b82019c4a17d8268544"));
        assert(genesis.hashMerkleRoot == uint256S("0x8d8570f468ae904ba5d4d1aab4c4d0eaf2db163f67debfd5981c9b686bf61afb"));
        ...
        vSeeds.emplace_back("node1.deccord.com");
        vSeeds.emplace_back("node2.deccord.com");
        vSeeds.emplace_back("sg1.inodes.one");
        vSeeds.emplace_back("sg2.inodes.one");
        vSeeds.emplace_back("sg3.inodes.one");
        vSeeds.emplace_back("sg4.inodes.one");
        vSeeds.emplace_back("sg5.inodes.one");
        vSeeds.emplace_back("sg6.inodes.one");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // Deccord BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Deccord BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Deccord BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"DKVnxjQdYco26spR9tf7EFrZS1iZae2775"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000ff69b23f0528de73cfdcb50a8b8f59a756253866b82019c4a17d8268544")},
            }
        };
        ...
        // getchaintxstats 17280 00000ff69b23f0528de73cfdcb50a8b8f59a756253866b82019c4a17d8268544
        chainTxData = ChainTxData{
                1740823402, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockMaturityWindow = 30;
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000361c39c01a943c369b8ccafb1638ab3088d4eb8adc2fa98e7fa7bef993f"); 
        ...
        genesis = CreateGenesisBlock(1740823407UL, 685814UL, 0x1e0ffff0, 1, 5 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000361c39c01a943c369b8ccafb1638ab3088d4eb8adc2fa98e7fa7bef993f"));
        assert(genesis.hashMerkleRoot == uint256S("0x8d8570f468ae904ba5d4d1aab4c4d0eaf2db163f67debfd5981c9b686bf61afb"));
        ...
        // Testnet Deccord BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Deccord BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Deccord BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TGprrKdHx1H7ZTdN99dEKX4jRPHGWfVysM"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000361c39c01a943c369b8ccafb1638ab3088d4eb8adc2fa98e7fa7bef993f")},
            }
        };
        ...
        // getchaintxstats 17280 00000361c39c01a943c369b8ccafb1638ab3088d4eb8adc2fa98e7fa7bef993f
        chainTxData = ChainTxData{
                1740823407, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1740823412, 0, 0x207fffff, 1, 5 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x32132c64a153f12fa14fbdb1179bf14125cac234ecd9be5d4ce3af5ff4235e2d"));
        assert(genesis.hashMerkleRoot == uint256S("0x8d8570f468ae904ba5d4d1aab4c4d0eaf2db163f67debfd5981c9b686bf61afb"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x32132c64a153f12fa14fbdb1179bf14125cac234ecd9be5d4ce3af5ff4235e2d")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 7VRDjT13C2n5R6yGSwswujxbo3N3f8NEi7MFXq7yJUVUAm21bev
        vSporkAddresses = {"TEUdpLr591euBqA6HjNGU4HMzXm56Zk64Q"};
        nMinSporkKeys = 1;
        ...
        // Regtest Deccord addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest Deccord script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest Deccord BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Deccord BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Deccord BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
