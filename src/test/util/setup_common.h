...
/* Initialize Deccord-specific components after chainstate initialization */
void DeccordTestSetup(NodeContext& node);
void DeccordTestSetupClose(NodeContext& node);
