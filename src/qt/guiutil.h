...
/** Utility functions used by the Deccord Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "deccord:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load deccord specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a deccord specific theme is activated (light/dark).*/
