...
Arguments:
    <base_directory> - The base directory of a Deccord Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Deccord Core developers'
...
Arguments:
    <base_directory> - The base directory of Deccord Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Deccord Core repository.
"""
