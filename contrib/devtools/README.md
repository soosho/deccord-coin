...
Setup
---------
Configuring the github-merge tool for the Deccord Core repository is done in the following way:

    git config githubmerge.repository deccordpay/deccord
...
A script to optimize png files in the deccord
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_deccord: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_deccord: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_deccord: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_deccord: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
