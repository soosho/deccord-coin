# Bootstrappable Deccord Core Builds

This directory contains the files necessary to perform bootstrappable Deccord
Core builds.
...
To build Deccord Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Deccord Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/deccord-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/deccordpay/guix.sigs).
...
[guix-docker]: https://github.com/Deccord/tree/master/contrib/guix/Dockerfile
