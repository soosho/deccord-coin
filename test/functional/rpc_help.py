...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: Deccord's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'Deccord', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
