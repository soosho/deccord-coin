...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 DCD from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 DCD in block rewards plus fees, but
        ...
        # Send 100 DCD with subtract fee from amount
        ...
        # Sendmany 100 DCD with subtract fee from amount
        ...
        # Sendmany with explicit fee (DCD/kB)
        ...
        # This will raise an exception for attempting to get the private key of an invalid Deccord address
        assert_raises_rpc_error(-5, "Invalid Deccord address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Deccord address
        assert_raises_rpc_error(-5, "Invalid Deccord address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Deccord address or script", self.nodes[0].importaddress, "invalid")
        ...
        # send with explicit deccord/kb fee
        self.log.info("test explicit fee (sendtoaddress as deccord/kb)")
        self.nodes[0].generate(1)
        self.sync_all(self.nodes[0:3])
