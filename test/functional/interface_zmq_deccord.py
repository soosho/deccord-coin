...
"""Test the deccord specific ZMQ notification interfaces."""
...
class DeccordZMQTest (DeccordTestFramework):
    def set_test_params(self):
        ...
        self.set_deccord_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_deccord_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that deccordd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all deccord related ZMQ publisher
