...
"""Verify that starting deccordd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start deccordd with -h for help text")
        ...
        self.log.info("Start deccordd with -version for version information")
        ...
        self.log.info("Start deccorddd with -fakearg to make sure it does not start")
