...
At the first startup Deccord Core will run a migration process which can take
...
incompatible with older versions of Deccord Core, so a db migration path was
...
See detailed [set of changes](https://github.com/Deccord/compare/v19.1.0...deccordpay:v19.2.0).
