...
- [`f7b71f660`](https://github.com/Deccord/commit/f7b71f660) Merge #13611: [bugfix] Use `__cpuid_count` for gnu C to avoid gitian build fail.
...
- [`c35aa663b`](https://github.com/Deccord/commit/c35aa663b) Merge #11326: Fix crash on shutdown with invalid wallet
...
- [`b93785d8d`](https://github.com/Deccord/commit/b93785d8d) Fix maxuploadtarget.py
...
- [`1b77cc81a`](https://github.com/Deccord/commit/1b77cc81a) No need to assert wait_until
...
- [`cd5a12f9f`](https://github.com/Deccord/commit/cd5a12f9f) Merge #10862: Remove unused variable int64_t nEnd. Fix typo: "conditon" → "condition".
...
- [`51a4e11d6`](https://github.com/Deccord/commit/51a4e11d6) deccordify what made sense in fuzzing.md
...
- [`cd490905b`](https://github.com/Deccord/commit/cd490905b) Merge #10999: Fix amounts formatting in `decoderawtransaction`
...
- [`07d08a822`](https://github.com/Deccord/commit/07d08a822) Merge #10912: [tests] Fix incorrect memory_cleanse(…) call in crypto_tests.cpp
...
- [`083c49e1d`](https://github.com/Deccord/commit/083c49e1d) Merge #10837: Fix resource leak on error in GetDevURandom
...
- [`6e2f77933`](https://github.com/Deccord/commit/6e2f77933) Merge #10747: [rpc] fix verbose argument for getblock in bitcoin-cli
...
- [`305fd0679`](https://github.com/Deccord/commit/305fd0679) Merge #10248: Rewrite addrdb with less duplication using CHashVerifier
...
- [`eef9c8ea1`](https://github.com/Deccord/commit/eef9c8ea1) Merge #10553: Simplify "bool x = y ? true : false". Remove unused function and trailing semicolon.
...
- [`535d7d6a8`](https://github.com/Deccord/commit/535d7d6a8) Merge #10347: Use range-based for loops (C++11) when looping over vector elements
...
- [`de9629553`](https://github.com/Deccord/commit/de9629553) Merge #9614: [wallet] [refactor] Simplify getbalance implementation
...
- [`0e556be70`](https://github.com/Deccord/commit/0e556be70) Merge #9494: Introduce an ArgsManager class encapsulating cs_args, mapArgs  and mapMultiArgs
...
- [`52de8b11d`](https://github.com/Deccord/commit/52de8b11d) Merge #10255: [test] Add test for listaddressgroupings
...
- [`f6c5d5802`](https://github.com/Deccord/commit/f6c5d5802) Merge #10272: [Tests] Prevent warning: variable 'x' is uninitialized
...
- [`b645757be`](https://github.com/Deccord/commit/b645757be) Call RemoveConflictedTx from BlockConnected instead of ProcessNewTransaction
...
- [`6bb55d547`](https://github.com/Deccord/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
...
- [`0d2f2b361`](https://github.com/Deccord/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/Deccord/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/Deccord/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/Deccord/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/Deccord/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/Deccord/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/Deccord/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/Deccord/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/Deccord/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/Deccord/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/Deccord/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/Deccord/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/Deccord/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/Deccord/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/Deccord/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/Deccord/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/Deccord/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/Deccord/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/Deccord/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/Deccord/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/Deccord/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/Deccord/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/Deccord/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/Deccord/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/Deccord/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/Deccord/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/Deccord/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/Deccord/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/Deccord/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/Deccord/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/Deccord/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/Deccord/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/Deccord/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/Deccord/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/Deccord/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/Deccord/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/Deccord/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/Deccord/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/Deccord/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/Deccord/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/Deccord/commit/1cfda206a) Merge #9993: Initialize nRelockTime
