# Support for Output Descriptors in Deccord Core

Since Deccord Core v0.17, there is support for Output Descriptors. This is a
...
existing Deccord Core wallets, a convenience function `combo` is
...
All RPCs in Deccord Core will include the checksum in their output. Only
