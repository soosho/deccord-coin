...
This mechanism has been integrated into Bitcore-Node-Deccord which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/deccordpay/insight-api-deccord#web-socket-api](https://github.com/deccordpay/insight-api-deccord#web-socket-api)
* API: [https://github.com/deccordpay/insight-api-deccord#instantsend-transactions](https://github.com/deccordpay/insight-api-deccord#instantsend-transactions)
