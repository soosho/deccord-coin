...
This document provides guidelines for internationalization of the Deccord Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `deccord_en.ts` remains unchanged.
